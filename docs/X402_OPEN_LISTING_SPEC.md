...
[X402_REFERRAL_SPEC](X402_REFERRAL_SPEC.md)의 후속이며 [LAUNCH_READINESS_SPEC](LAUNCH_READINESS_SPEC.md) §4(x402 검증 잡, PR30 체인에서 구현 완료)를 전제로 얹는다 — 배관(017/018/028, verify, claim)은 그대로 두고 **공급·등록·수익 제품**만 추가.
