...
## 유료 툴 (x402 결제 필요 — HTTP 402)

> Claude Code / Cursor는 결제를 완료할 수 없습니다.
> x402 지갑이 연결된 HTTP 클라이언트 또는 REST API로 직접 호출하세요.
> MCP로 시도하면 "Connection closed" 에러가 정상입니다.

### 9. check_endpoint_health — 엔드포인트 생존 확인 ($0.001)
...
### 10. export_toolkit — 툴킷 내보내기 ($0.01)
...
### 11. recommend_verified_tool — 검증된 추천 ($0.01)
