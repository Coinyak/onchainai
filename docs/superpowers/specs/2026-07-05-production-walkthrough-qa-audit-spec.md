...
| **XP3** | x402 최초 제출자용 안내 부재 — "we probe it for a valid 402 handshake" 한 줄뿐, 유효 응답 예시·스펙 링크 없음 | 프론트 submit X402 뷰. 정본 `docs/X402_OPEN_LISTING_SPEC.md` 존재하나 미링크 | 예상 402 응답 형식 예시 + `X402_OPEN_LISTING_SPEC` 링크 추가 | P2 | 🔲 |
