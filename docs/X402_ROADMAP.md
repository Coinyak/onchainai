...
>
> Last updated: **2026-07-04** (창업자 대화 기준)  
...
| Ship | KPI | 상태 |
|------|-----|------|
| Bazaar 크롤 시드 (L2) | 승인된 Bazaar 툴 ≥30 | ☐ |
...
| “이번에 뭐 나가?” | §3 IN만. vet·제공자 결제·Bazaar는 OUT. |
...
| # | 채널 | 등록 방식 | 상태 | 메모 |
|---|------|-----------|------|------|
| X9 | **Bazaar 크롤 시드 (L2)** | CDP discovery API → 운영자 승인 큐 | ☐ | Phase 2 — `referral_enabled=false` 기본 |
