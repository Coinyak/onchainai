...
### 보류 (Deferred)
~~**K(수익화) 전체 — 트래픽·사용량 확보 후.**~~ → **2026-07-04 오너 결정으로 보류 해제.** 실행 스펙: [X402_OPEN_LISTING_SPEC](X402_OPEN_LISTING_SPEC.md) (오픈 등록 L1–L5, M2=K3, M3=K2) + x402 activation 스펙(K1 운영화). 원문 유지: 어트리뷰션 인프라(K1)는 계속 데이터 축적.
