...
const TOOLS = [
  ...
  tool({
    ...
    install_command: "npx add-mcp https://mcp.base.org",
  ...
  tool({
    ...
    install_command: "npx add-mcp https://docs.base.org/mcp",
  ...
  tool({
    ...
    install_command: "npx add-mcp https://docs.optimism.io/mcp",
  ...
  tool({
    ...
    install_command: "npx add-mcp https://docs.polygon.technology/mcp",
  ...
  tool({
    ...
    install_command: "npx add-mcp https://mcp.api.coingecko.com/mcp",
