...
use crate::server::queries::{
    list_tools_order_clause, DashboardCountAxis, APPROVED_TOOL_BY_SLUG_SQL,
    APPROVED_TOOL_ID_BY_SLUG_SQL, CATEGORIES_WITH_COUNTS_SQL, CHAIN_COUNTS_SQL,
    COUNT_APPROVED_TOOLS_SQL, DASHBOARD_FUNCTION_COUNTS_SQL, DASHBOARD_METRICS_SQL,
    DASHBOARD_X402_TOOLS_SQL, IS_BOOKMARKED_SQL, LIST_APPROVED_TOOLS_SQL,
    RECENT_APPROVED_TOOLS_SQL, SEARCH_APPROVED_TOOLS_SQL, TOOL_COMMENTS_NEW_SORT_SQL,
    TOOL_COMMENTS_TOP_SORT_SQL, TOOL_COMMENT_COUNTS_BY_SLUGS_SQL, TOOL_COMMENT_COUNT_BY_SLUG_SQL,
    USER_TOOLKIT_SQL,
};
#[cfg(feature = "ssr")]
