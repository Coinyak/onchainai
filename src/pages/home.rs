...
pub fn HomePage() -> impl IntoView {
    ...
    view! {
        <Suspense fallback=|| view! { <ToolsBrowser base=BrowserBase::Home show_toolbar_search=false/> }>
            {move || match header.get() {
                ...
                None => view! { <ToolsBrowser base=BrowserBase::Home show_toolbar_search=false/> }.into_any(),
            }}
        </Suspense>
    }
}
