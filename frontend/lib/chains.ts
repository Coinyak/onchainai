...
export const CHAIN_CATALOG: ChainMeta[] = [
  ...
  { id: "sonic", label: "Sonic", logo: "/chains/sonic.svg", aliases: ["sonic-mainnet", "fantom", "ftm", "fantom-mainnet"], pinned: false },
  ...
  { id: "ton", label: "TON", logo: "/chains/ton.svg", aliases: ["the-open-network", "ton-mainnet", "gram", "gram-token", "toncoin"], pinned: false },
